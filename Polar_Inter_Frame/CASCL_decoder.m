function [polar_info_esti, CRC_check] = CASCL_decoder(llr, L, info_index, frozen_bits, poly, lambda_offset, llr_layer_vec, bit_layer_vec, mutual_bits)%2018.1.7.14:16 Yu Y. R.
...
for l_index = 1 : L
    ...
    % For SPC, a problem appeared here!
    %The CRC check input is the estimates of the ui, but CRC add is the
    %source bits of the encode bits Xa_crc.
    err = sum(crccheck_m(info_with_crc',poly));
    if err == 0
